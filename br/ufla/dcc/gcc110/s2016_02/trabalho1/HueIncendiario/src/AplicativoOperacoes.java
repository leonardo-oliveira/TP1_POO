...
public class AplicativoOperacoes implements Serializable {
   ...
   public AplicativoOperacoes() {
    ...
    public void register() {
      ...
      verifyChanges(appArray);
      saveDate(appArray);
      Principal.clearConsole();
   }

   private void verifyChanges(ArrayList<Aplicativo> appArray){
      ...
      */
      public void saveDate(ArrayList<Aplicativo> appArray) {
         try {
            ...
            System.out.println("+ [X] Ops: Houve um erro na leitura do arquivo de dados.");
         }
      }
   ...
   private Aplicativo search(String appName) {
      ...
      try {
         ...
         while((app = (Aplicativo)oi.readObject()) != null) {
      ...
      System.out.println("+ [X] Ops: Houve uma falha na leitura do arquivo.\nPressione ENTER para continuar...");
      return null;
    }
  }
